...
class M2contacts {
  ...
  public function __construct($user = null, $mbox = null) {
    ...
    try {
      ...
      melanie2_logs::get_instance()->log(melanie2_logs::ERROR, "[Resources] M2contacts::__construct() Melanie2DatabaseException");
      return false;
    }
    catch (\Exception $ex) {
      return false;
  ...
  public function getAcl() {
    ...
    try {
      ...
      melanie2_logs::get_instance()->log(melanie2_logs::ERROR, "[Resources] M2contacts::getAcl() Melanie2DatabaseException");
      return false;
    }
    catch (\Exception $ex) {
      return false;
  ...
  public function setAcl($user, $rights) {
    ...
    try {
      ...
      if ($this->group === true) {
        ...
        if (strpos($user, "mineqRDN=") !== 0 || strpos($user, "ou=melanie,ou=organisation,dc=equipement,dc=gouv,dc=fr") === false) {
          return false;
        }
      ...
      melanie2_logs::get_instance()->log(melanie2_logs::ERROR, "[Resources] M2contacts::setAcl() Melanie2DatabaseException");
      return false;
    }
    catch (\Exception $ex) {
      return false;
  ...
  public function deleteAcl($user) {
    ...
    try {
      ...
      melanie2_logs::get_instance()->log(melanie2_logs::ERROR, "[Resources] M2contacts::deleteAcl() Melanie2DatabaseException");
      return false;
    }
    catch (\Exception $ex) {
      return false;
  ...
  public function createAddressbook($name = null) {
    try {
      ...
      melanie2_logs::get_instance()->log(melanie2_logs::ERROR, "[Resources] M2contacts::createAddressbook() Melanie2DatabaseException");
      return false;
    }
    catch (\Exception $ex) {
      return false;
  ...
  public function resources_elements_list($attrib) {
    ...
    try {
      ...
      melanie2_logs::get_instance()->log(melanie2_logs::ERROR, "[Resources] M2contacts::resources_elements_list() Melanie2DatabaseException");
      return false;
    }
    catch (\Exception $ex) {
      return false;
  ...
  public function acl_frame($attrib) {
    ...
    $attrib['src'] = $this->rc->url(array('_action' => 'plugin.melanie2_contacts_acl','id' => $id,'framed' => 1));
    $attrib['width'] = '100%';
    $attrib['height'] = 275;
    $attrib['border'] = 0;
...
class M2contactsgroup extends M2contacts {
  ...
  public function acl_frame($attrib) {
    ...
    $attrib['name'] = $attrib['id'];
    $attrib['src'] = $this->rc->url(array('_action' => 'plugin.melanie2_contacts_acl_group','id' => $id,'framed' => 1));
    $attrib['width'] = '100%';
    $attrib['height'] = 275;
    $attrib['border'] = 0;
    $attrib['border'] = 'border:0';
