...
class M2tasks {
  ...
  public function __construct($user = null, $mbox = null) {
    ...
    try {
      ...
      melanie2_logs::get_instance()->log(melanie2_logs::ERROR, "[Resources] M2tasks::__construct() Melanie2DatabaseException");
      return false;
    }
    catch (\Exception $ex) {
      return false;
  ...
  public function getAcl() {
    ...
    try {
      ...
      melanie2_logs::get_instance()->log(melanie2_logs::ERROR, "[Resources] M2tasks::getAcl() Melanie2DatabaseException");
      return false;
    }
    catch (\Exception $ex) {
      return false;
  ...
  public function setAcl($user, $rights) {
    ...
    try {
      ...
      melanie2_logs::get_instance()->log(melanie2_logs::ERROR, "[Resources] M2tasks::setAcl() Melanie2DatabaseException");
      return false;
    }
    catch (\Exception $ex) {
      return false;
  ...
  public function deleteAcl($user) {
    ...
    try {
      ...
      melanie2_logs::get_instance()->log(melanie2_logs::ERROR, "[Resources] M2tasks::deleteAcl() Melanie2DatabaseException");
      return false;
    }
    catch (\Exception $ex) {
      return false;
  ...
  public function createTaskslist($name = null) {
    try {
      ...
      melanie2_logs::get_instance()->log(melanie2_logs::ERROR, "[Resources] M2tasks::createTaskslist() Melanie2DatabaseException");
      return false;
    }
    catch (\Exception $ex) {
      return false;
  ...
  public function resources_elements_list($attrib) {
    ...
    try {
      ...
      melanie2_logs::get_instance()->log(melanie2_logs::ERROR, "[Resources] M2tasks::resources_elements_list() Melanie2DatabaseException");
      return false;
    }
    catch (\Exception $ex) {
      return false;
  ...
  public function acl_frame($attrib) {
    ...
    $attrib['src'] = $this->rc->url(array('_action' => 'plugin.melanie2_tasks_acl','id' => $id,'framed' => 1));
    $attrib['width'] = '100%';
    $attrib['height'] = 275;
    $attrib['border'] = 0;
...
class M2tasksgroup extends M2tasks {
  ...
  public function acl_frame($attrib) {
    ...
    $attrib['name'] = $attrib['id'];
    $attrib['src'] = $this->rc->url(array('_action' => 'plugin.melanie2_tasks_acl_group','id' => $id,'framed' => 1));
    $attrib['width'] = '100%';
    $attrib['height'] = 275;
    $attrib['border'] = 0;
    $attrib['border'] = 'border:0';
